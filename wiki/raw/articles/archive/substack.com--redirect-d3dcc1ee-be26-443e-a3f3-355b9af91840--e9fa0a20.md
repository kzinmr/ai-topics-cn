---
title: "Untitled"
url: "https://substack.com/redirect/d3dcc1ee-be26-443e-a3f3-355b9af91840?j=eyJ1IjoiMmZseDYifQ.6O_iC1_GWCzChnbrHzSrs1hMpJpoODTUJm_FAk3tf6E"
fetched_at: 2026-04-23T06:28:07.391908+00:00
...
Source: https://substack.com/redirect/d3dcc1ee-be26-443e-a3f3-355b9af91840?j=eyJ1IjoiMmZseDYifQ.6O_iC1_GWCzChnbrHzSrs1hMpJpoODTUJm_FAk3tf6E

本文来自微信公众号：
叶小钗
，作者：叶小钗，题图来自：AI生成
最近经常听到的两句话是：
如果你的系统还在 GUI 上打转，没有跟进 CLI，那么你将被淘汰；
...
每个工具接口改一下，要排查多少个 Agent 在用；
每个模型的 tool schema 不同，还要做额外适配；
每加一个新系统，不只是加一个 API，而是还要处理参数、鉴权、重试、映射、降级。
...
他们都是那种直接给我干得一眼抓瞎，TMD 还得重头学习，甚至还得搜攻略的东西
（这些家伙绝壁是故意的）
！
这个时候，整体问题就变成了：
...
比如：
升级前必须先调用：
dingtalk doc-space upgrade --plan
--dry-run --output json
不要直接使用 --confirm
