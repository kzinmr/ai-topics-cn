...
#### 注目すべきAbsent
- Qwen4.0等の次世代モデルリリースなし
- Qwen Code v0.17.x安定版リリースなし（プレビュー継続、計90日以上）
- Token Plan/Lingma/Qoderの価格改定なし
...
#### Qwen 3.8 オープンウェイト化（2026年8月中旬）⭐
- Juejin「本地跑一个 Qwen 3.8，你将拥有一个 Opus 4.6」(8/17投稿)が「**Qwen 3.8 迎来了开放权重的时刻**」と確認。7月下旬のプレビュー以来、**オープンウェイト化が実現**したことを示す。
- 記事タイトルはローカルデプロイで「**Opus 4.6級**」の体験が得られると宣伝し、DeepSeek-V4-pro/Grok 4.6/DeepSeek Harness/GLM 5.3に続く8月中旬のモデルラッシュの中でQwenの位置づけを強調。
- 安定版リリースの公式確認は未達（プレビュー継続）
