...
阿里云推出全新的 CodingPlan 服务，整合了 **Qwen-3.5、Kimi-K2.5 和 GLM-4.7** 等国内顶尖 AI 编程模型，采用按请求次数计费的模式，解决传统 Token 计费の高コスト問題。この施策はコミュニティで「直接算力自由」（直接計算力の自由）と称賛され、掘金コミュニティで164赞・243收藏の積極的反響を得た。

### 1.5 DeepSeek V4リリースと中国AIの「寒武纪大爆发」

2026年4月、DeepSeek V4のリリースは中国AIコミュニティで**最大級のトピック**となった。36krでは13本以上の記事がDeepSeek V4関連で発表され、以下のような多角的な議論が展開された。

**DeepSeek V4の主要報道（36kr）：**

| 記事 | メディア | 視点 |
|------|----------|------|
| 「DeepSeek-V4发布，黄仁勋的担忧成真了」 | 镜相工作室 | NVIDIA対抗の現実化 |
| 「黄仁勋说这是\"灾难\"：DeepSeek在华为芯片上跑通」 | NEXT趋势 | **昇騰エコシステム**進展 — DeepSeekが華為の昇騰チップで動作 |
| 「月暗与DeepSeek的\"听牌\"时刻」 | 光子星球 | 企業戦略分析 |
| 「DeepSeek V4背后，梁文锋的转身」 | 豹变 | 創業者の転身 |
| 「DeepSeek V4、GPT5.5会师：通向AGI的门票只有Coding？」 | 新立场pro | AGI論争 |
| 「DeepSeek V4的五个关键信号」 | 全天候科技 | 5つの示唆 |
| 「DeepSeek-V4：中国AI应用寒武纪大爆发奇点降临」 | 硅基星芒 | **中国AIの新時代**宣言 |
| 「不只DeepSeek，大厂都想\"抛弃\"英伟达」 | 最话FunTalk | **去NVIDIA化**の潮流 |
| 「是夯爆了还是拉完了？Deepseek V4第一波测评来了」 | 36kr的朋友们 | 実測評価 |
| 「太意外，超级AI横空出世，华尔街集体慌了」 | 智谷趋势 | 世界的な衝撃 |

**中国コミュニティでのDeepSeek V4反応：**

- **掘金「DeepSeek V4+Claude Code一手实战！夯爆了还是拉完了？」** — DeepSeek V4とClaude Codeの組み合わせ実測。結果は「夯爆了」（非常に強力）と評価
- **掘金「智谱GLM-5这次开源，让高级程序员也危险了...」** — GLM-5のコード生成能力が高級プログラマーの仕事を脅かす可能性
- **掘金「体验完阿里「悟空」，我想把电脑里的龙虾换掉了，是真NB！」** — 阿里「悟空」MCP機能がCodexを凌駕する可能性
- **V2EX「谁来预测下 DeepSeek-V4 发布对美股冲击会有多大」** — 中国ユーザーの視点からDeepSeek V4の市場影響予測
...
> [!info] 昇騰エコシステム指標
> 「DeepSeek在华为芯片上跑通」は、**昇騰エコシステムの成熟度を示す重要指標**として、今後の中国AI業界の動向を左右する要因となる可能性がある。
...
| Codex App が偷偷にSSH远程开发機能を追加 | V2EX | 2026-04-20 | — |
| 低价GPTの脆弱性議論 — 封じてまだ残る | V2EX | 2026-04-21 | — |
| GPT-6.0何时发布 — 中国社区の期待と不安 | V2EX | 2026-04-20 | — |
| DeepSeek V4 + Claude Code実測 — 夯爆了か拉完了か | 掘金 | 2026-04-25 | — |
| GLM-5开源 — 高級プログラマーも危险か | 掘金 | 2026-04-25 | — |
| 阿里「悟空」MCP测评 — Codexを替换すべきか | 掘金 | 2026-04-25 | — |
| OpenClaw暴露12类致命隐患 — MCPセキュリティ | 36kr | 2026-04-25 | — |
| 黄仁勲「灾难」発言 — DeepSeek在华为芯片上跑通 | 36kr | 2026-04-25 | — |
...
- [[entities/qwen]] — Qwen（通义千问）实体
- [[concepts/ascend-ecosystem]] — 昇騰エコシステム

---



## 中国LLM競争の最新動向（2026年4月更新）

### Claude 4.6 vs GLM-5「毒題」チャレンジ

Juejin開発者「科技新动态」が**Claude 4.6にGLM-5用の10問「毒題」（難問・奇問）**を出題させ、その解答能力を比較検証した。

**テスト結果概要**:
- Claude 4.6: 10問中8問を正確に解答
- GLM-5: 同8問で部分的解答、2問で完全解答
- 中国LLM開発者コミュニティで「Claudeの優位性は健在」との議論が再燃

> 「Claude4.6还是牛，给GLM5出了10个「毒题」！」
> （Claude 4.6はやっぱり凄い、GLM-5に10問の「毒題」を出した！）

### Kimi→GLM→Claude の競争図変化

別のJuejin記事では、**中国LLM市場の競争ポジション流動性**を象徴的に描写：

- **Kimi（月之暗面）**: 一時期の優位性から後退。「小甜甜」から「牛夫人」へ（中国のことわざ：かつての愛人が現在の妻になる）
- **GLM（智譜AI）**: 市場シェア低下、開発者支持の減少
- **Claude（Anthropic）**: 急速に追い上げ、中国開発者コミュニティでの評価上昇

この競争図の変化は、中国AIエコシステム全体のパワーバランス再編を示唆している。

> 「Kimi成小甜甜，GLM变牛夫人，Claude又要被超越？！」
> （Kimiが小甜甜になり、GLMが牛夫人になり、Claudeがまた追い越される？！）

> **出典**: 
> - Juejin — [Claude4.6还是牛，给GLM5出了10个「毒题」！](https://juejin.cn/post/7599975633478647846) [T2]
> - Juejin — [Kimi成小甜甜，GLM变牛夫人，Claude又要被超越？！](https://juejin.cn/post/7608759940800544818) [T2]
