...
#### リリース概要
- **リリース日**: 2026年4月24日（V4 PreviewとしてWeb公開）
- **総パラメータ**: ~1T（1兆）、**活性化パラメータ**: ~37B/トークン
- **コンテキスト**: 100万（1M）tokens
- **アーキテクチャ**: MoE + mHC + Engram（新設計）
- **訓練ハードウェア**: 華為昇騰910C + Cambricon MLU（Nvidia非依存、完全国産）
- **ライセンス**: Apache 2.0
- **API価格**: $0.30/MTok（推定）

#### ベンチマーク（V4 Preview、検証中）
|| ベンチマーク | V4 Preview | 備考 |
||-------------|------------|------|
|| MMLU | 93.9 | HumanEvalのデータがMMLUに含まれるため高値 |
|| HumanEval | 96.2 | コーディング性能が突出 |
|| SWE-bench Verified | 92.3 | Claude Opus 4.6 (80.9%)を大幅上回る |
|| AIME | 90.7 | 数学推論が非常に高い |
|| GPQA-Diamond | 96.4 | 博士級科学問題 |
|| LiveBench | 71.5 | 生データでの検証 |
|| IFBench | 79.0 | 歴史的最新記録 |
