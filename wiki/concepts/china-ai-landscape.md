...
## 2026年8月 — 広東AI人材の台頭と深センのジレンマ

### 「広東幫」の台頭

ChinAI #370（2026-08-10）の分析によると、2025〜2026年にかけて**広東出身のAI研究者**が業界の注目を集めている：

| 人物 | 成果 | 注目度 |
|------|------|--------|
| 蘇剣林 | Kimi K3共同一作。DeepSeek V4 Flash | 「蘇神」として硅谷まで波及 |
| 陳広宇 | Kimi K3共同一作 | 蘇剣林と並ぶ注目人物 |
| 梁文鋒 | DeepSeek創設者 | 広東出身だが杭州で創業 |
| 楊植麟 | Moonshot（月之暗面）創設者 | 広東出身 |

### 深センにスターAI企業が不在な理由

- 2024年初頭から「深セン、なぜ大模型から見捨てられたか」という議論が存在
- 広東在りしてモデル智能上限（intelligent ceiling）競争に参加したのは**腾讯のみ**
- 腾讯はWorkBuddy（月間2,097万访问、中国桌面端AI原生办公智能体トップ）でAgentに注力だが、基礎モデル競争では第一線から遅れ
- **ビジネス思考 vs 政治思考**のメタファー：北京はPolitics（控制・権力）、広東はBusiness（自由・成長）の思维方式
- 深センの人才流出：北京・上海・杭州へ流れる研究者、資金、ユーザーの集中

### 広東の潜在力

- 互联网時代のBATで深セン企業は常に上位（腾讯 → 時代を越えて屹立）
- 各時代に深センから一家が資源虹吸効果を持つ企業が成長してきた歴史
- **「Realな問題を解決する」**実務的アプローチが広東の特徴：DeepSeek（算力コスト削減）、Kimi K3（位置エンコーディング革新）
- To VC / To Government / To Customers の創業パターン分類

> **出典**: ChinAI #370「Why is there No Star AI Company from Guangdong?」（陳彩娴/2026-08-10）

### 関連：トレーニングデータの地政学

詳細は[[china-ai-data-supply]]を参照。米国データラベリング企業が中国AI実験室に年間$5億を供給するサプライチェーンが初めて詳細報道された（Forbes/2026-08-10）。
