...
## GPT-5.5正式評価（2026-04-24）

2026年4月24日、GPT-5.5の正式評価が中国AIコミュニティで議論され始めた。

**36kr（量子位）の報道**：
- 「**刚刚，GPT-5.5发布，更强更快更贵，内测英伟达工程师：失去它像被截肢**」— GPT-5.5は**全榜第一**でClaude Opus 4.7を圧倒
- NVIDIA内部テスターは「GPT-5.5を失うことは被截肢（肢切除）のようなものだ」と評価
- 「**GPT-5.5来了，全榜第一碾压Opus 4.7，OpenAI今夜雪耻**」— GPT-5.5はベンチマーク全分野でOpus 4.7を上回る性能

**36kr（字母AI）のテスト結果**：
- 「**实测GPT5.5 : 最强模型不是嘴炮，它真能干活儿**」— 実作業能力でGPT-5.5が実証
- コーディング、推論、多模态処理の全ての分野で実用的な性能を発揮

**価格問題**：
- 「**更强更快更贵**」— 性能向上は確実だが、コスト増も顕著
- V2EXで「**GPT5.5在codex中credit消耗量相比5.4翻倍**」（CodexでのCredit消費量が5.4の2倍）との報告

**GPT vs Opus 4.7の温度差**：
- V2EXで「**天下苦Claude久矣，GPT就出招了，5.5目测下限是opus 4.6**」— Claudeに苦しめられてきた中国ユーザーがGPT-5.5の登場を歓迎
- 一方で「**很难评，GPT5.5发布，Opus4.6降智问题也处理好了，DeepSeek V4也发布了**」— 3つのモデルが相次いでアップデートされ、比較が複雑化

> **出典**: 36kr（量子位）— [刚刚，GPT-5.5发布，更强更快更贵](https://36kr.com/p/3780017637250311) [T1]
> **出典**: 36kr（新智元）— [GPT-5.5来了，全榜第一碾压Opus 4.7](https://36kr.com/p/3780018156311810) [T1]
> **出典**: 36kr（字母AI）— [实测GPT5.5](https://36kr.com/p/3780114152878855) [T1]

## GPT 6.0待機議論（2026-04）

中国V2EXコミュニティでは、GPT-6.0のリリース時期に関する議論が活発化している。

- **「gpt 6.0到底什么时候发布呀，各种新闻说明天发，怎么还没动静，隔壁claude都发布最新的了」**（2026-04-20 V2EX）— 毎日のように「明日発表」との噂が流れるが、Actualなリリースがない状態
- Claude Opus 4.7（Anthropic）が最新リリースを続ける中で、OpenAIのペースへの不満が蓄積

これはOpenAI vs Anthropicの**リリース速度競争**におけるOpenAIの遅れを示す指標として注目される。
...
### 低価格サブスクリプション問題と最新脆弱性

中国コミュニティではGPTの低価格利用（「低价 GPT」）が長期間の話題となっている。2026年4月、新たな脆弱性議論がV2EXで沸騰した。

- **GPT Codexサブスクリプション脆弱性** — アングラで流通していた低価格サブスクリプションがOpenAI公式に露見
- **2026-04-21 V2EX「低价 GPT 到底有多少漏洞，怎么封了还有」**（V2EX #1207040）— 低価格GPTサービスの継続的な脆弱性問題が議論。OpenAIが脆弱性を封じても新たな抜け道が発見される「猫と鼠」ゲームの継続
- **2026-04-18 アーカイブ「低价 GPT 订阅漏洞已被捅到官方脸上」** — 脆弱性が公式に報告・露見された事例
...
> **出典**: V2EX — 複数スレッド [T1]
> **出典**: wiki/raw/articles/ — アーカイブ記事 [T2]
